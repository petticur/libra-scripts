...
fresh_score=$(libra query --url ${rpc_endpoint} view --function-id 0x1::page_rank_lazy::calculate_score --args ${account_address} | jq '.body[0]' | tr -d '"')
